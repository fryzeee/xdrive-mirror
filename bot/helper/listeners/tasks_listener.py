        ...
        if self.isLeech:
            ...
            if not files:
                ...
                if self.isSuperGroup and not self.message.chat.has_protected_content:
                    buttons.ibutton('🤝 Send Me to DM 🤝', 'save', 'footer')
            ...
            if link or rclonePath and config_dict['RCLONE_SERVE_URL']:
                ...
                if link:
                    if not config_dict['DISABLE_DRIVE_LINK']:
                        buttons.ubutton("⚡️ Google Drive ⚡️", link)
                else:
                ...
                if rclonePath and (RCLONE_SERVE_URL := config_dict['RCLONE_SERVE_URL']):
                    ...
                    if mime_type == "Folder":
                        share_url += '/'
                    buttons.ubutton("☁️ RC Clone ☁️", share_url)
                elif not rclonePath:
                    ...
                    if INDEX_URL:
                        ...
                        if mime_type == "Folder":
                            share_url += '/'
                            buttons.ubutton("🔥 Drive IndeX 🔥", share_url)
                        else:
                            buttons.ubutton("🔥 Drive IndeX 🔥", share_url)
                ...
                if self.logMessage:
                    if link and config_dict['DISABLE_DRIVE_LINK']:
                        buttons.ubutton("⚡️ Google Drive ⚡️", link, 'header')
